...
export const operationalTables = [
  ...
  _create({
    ...
    columns: [
      ...
      {
        id: 'id4',
        columnName: 'ntd_material',
        name: 'НТД на материал',
        type: 'string',
        index: true,
        maxLength: 255,
      },
      {
        id: 'id5',
        columnName: 'classificator_ens',
        name: 'Классификатор ЕНС',
        type: 'string',
        index: true,
        maxLength: 255,
      },
      {
        id: 'id6',
        columnName: 'classificator_ens_code',
        name: 'Классификатор ЕНС: код',
        type: 'string',
        index: true,
        maxLength: 255,
      },
      {
        id: 'id7',
        columnName: 'is_name_correct',
        name: 'Корректно ли сформировано наименование',
        type: 'string',
        index: true,
        maxLength: 255,
      },
