...
export const createProcessSchema = v.omit(baseProcessSchema, ['id', ...getObjectKeys(creatableModel.entries)])
...
export const updateProcessSchema = v.omit(baseProcessSchema, ['id', ...getObjectKeys(creatableModel.entries)])
