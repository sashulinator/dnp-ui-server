...
export type OrderByWithRelationInput = Prisma.NormalizationConfigArchiveOrderByWithRelationInput
export type Select = Prisma.NormalizationConfigArchiveSelect
...
export default class Service {
  ...
  async getFirst(whereUniqInput: WhereUniqueInput): Promise<NormalizationConfig> {
    return this.prisma.normalizationConfigArchive
      .findFirstOrThrow({
  ...
  async findFirst(
    ...
    return this.prisma.normalizationConfigArchive.findFirst(params)
  }
  ...
  async findUnique(whereUniqInput: WhereUniqueInput): Promise<NormalizationConfig | null> {
    return this.prisma.normalizationConfigArchive.findUnique({
      where: whereUniqInput,
    })
  }
  ...
  async findMany(
    ...
    return this.prisma.normalizationConfigArchive.findMany({
      skip,
      take,
      cursor,
      where,
  ...
  async findAndCountMany(
    ...
    return this.prisma.$transaction([
      this.prisma.normalizationConfigArchive.findMany({ ...commonArgs, take, skip, select }),
      this.prisma.normalizationConfigArchive.count(commonArgs),
    ])
  }
  ...
  async remove(where: WhereUniqueInput): Promise<NormalizationConfig> {
    return this.prisma.normalizationConfigArchive.delete({
      where,
    })
  }
